...
def joint_train_world_model_agent(env_name, max_steps, num_envs, image_size,
    ...
    current_obs, target, _ = vec_env.reset()
        ...
        if replay_buffer.ready():
            ...
            with torch.no_grad():
                if len(context_action) == 0:
                    ...
                    a = torch.cat(list(context_obs), dim=1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", type=str, default='DreamerNavigation-100k-seed1')
    ...
    parser.add_argument("-trajectory_path", type=str, default='trajectory/DreamerNavigation.pkl')
   ...
   # seed_np_torch(seed=args.seed)
    ...
    if conf.Task == "JointTrainAgent":
        ...
        #env = Environment({'scene_name': 'bathroom_02', 'terminal_state_id': 26})
