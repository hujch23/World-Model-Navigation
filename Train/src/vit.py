...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_c=6, embed_dim=768, norm_layer=None):
        super().__init__()
...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_c=6, num_classes=1000,
                 embed_dim=768, depth=4, num_heads=4, mlp_ratio=4.0, qkv_bias=True,
...
if __name__ == '__main__':
    ...
    inputs = torch.rand(10, 6, 128, 128)
