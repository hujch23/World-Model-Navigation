...
class PPOTrainer(BaseRLTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config) -> None:
        ...
        #     pickle.dump(self.obs_space, f)
        with open('2.pkl', 'wb') as f:
            pickle.dump(self.policy_action_space, f)
        with open('3.pkl', 'wb') as f:
            pickle.dump(self.orig_policy_action_space, f)
        ...
        self.ckpt_dict = self.load_checkpoint('results/ckpt.0.pth', map_location="cpu")
        self.actor_critic.load_state_dict(self.ckpt_dict["actor_critic_state"])
        torch.save(self.actor_critic, 'model.pth')
        print('1')
